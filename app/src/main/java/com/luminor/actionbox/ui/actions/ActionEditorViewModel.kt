...
class ActionEditorViewModel @Inject constructor(
    ...
    val contentLinks = repository.observeOwnerLinks("ACTION", id).stateIn(viewModelScope, SharingStarted.WhileSubscribed(5_000), emptyList())
    ...
    fun duplicateAction(context: Context, original: ActionEntity) = execute { actionCommands.duplicateAction(context, original) }
